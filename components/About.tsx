            ...
            <div className="relative">
              <div className="aspect-video relative rounded-lg overflow-hidden shadow-xl">
                ...
                <div className="absolute inset-0 flex items-center justify-center">
                  <button aria-label="Play video" className="bg-white/90 rounded-full p-4 shadow-lg hover:bg-white transition-colors focus-visible:ring-2 focus-visible:ring-teal-500">
