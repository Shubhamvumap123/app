              ...
              <div className="aspect-video relative rounded-lg overflow-hidden shadow-xl">
                ...
                <div className="absolute inset-0 flex items-center justify-center">
                  <button
                    ...
                    className="bg-white/90 rounded-full p-4 shadow-lg hover:bg-white transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-teal-600 focus-visible:ring-offset-2"
                  >
                    <svg aria-hidden="true" className="w-8 h-8 text-teal-900" fill="currentColor" viewBox="0 0 20 20">
