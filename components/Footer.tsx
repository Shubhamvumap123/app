          ...
          <div className="grid md:grid-cols-4 gap-8 mb-12">
            ...
            <div>
              ...
              <form className="flex flex-col gap-2" onSubmit={handleSubscribe}>
                ...
                />
                <Button type="submit" disabled={loading} className="w-full bg-teal-600 hover:bg-teal-700 text-white font-semibold">
                    {loading ? <><Loader2 className="mr-2 h-4 w-4 animate-spin" /> Subscribing...</> : <>Subscribe <Send className="ml-2 h-4 w-4" /></>}
                </Button>
              </form>
            </div>
          </div>
