...
// Optimization: Hoisting static 'facilities' array outside the component scope
...
// for the static facility list, achieving O(1) allocation instead of O(n) per render.
const facilities = [
  {
    title: "Clay Courts",
