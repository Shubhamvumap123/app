...
// ⚡ Bolt: Hoisted static images array outside of component to prevent re-allocation on every render
const IMAGES = [
...
// ⚡ Bolt: Hoisted static categories array outside of component
const CATEGORIES = ["All", "Tournaments", "Training", "Facilities", "Events", "Coaches", "Camps"];

export default function GalleryPage() {
  const [filter, setFilter] = useState("All");

  // ⚡ Bolt: Memoized the derived filtered array to avoid recalculation unless filter changes
