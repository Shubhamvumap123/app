...
// Performance optimization: Hoist static arrays outside component to prevent
// redundant memory allocation and garbage collection on every re-render.
const IMAGES = [
...
export default function GalleryPage() {
  ...
  // array operations on re-renders when the filter hasn't changed.
