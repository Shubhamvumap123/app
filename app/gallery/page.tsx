...
// ⚡ Bolt: Define interface for type safety
...
// ⚡ Bolt: Hoist static data out of the component scope to avoid re-allocation on every render
...
export default function GalleryPage() {
  ...
  // ⚡ Bolt: Memoize filtered images to prevent redundant calculations during re-renders
