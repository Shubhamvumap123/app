...
// ⚡ Bolt: Hoisted static arrays to prevent re-allocation on every render
const IMAGES = [
...
export default function GalleryPage() {
  ...
  // ⚡ Bolt: Memoized derived state to avoid redundant filtering calculations when other state changes
